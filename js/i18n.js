...
const I18N = {
  ja: {
    ...
    "footer.orgName": "認定NPO法人 Globe Jungle",
    ...
    "footer.contactKh": "カンボジア事務所：プノンペン",
  ...
  en: {
    ...
    "story.card1.body": "A home for 22 children. We provide daily meals, education, and healthcare — supporting each child until they can stand on their own.",
    "story.card2.icon": "🌅",
    ...
    "support.stat3.unit": "",
    "support.stat3.label": "Children living at<br>Kukuma Orphanage",
    "support.stat4.unit": "+",
    ...
    "donate.item1.goal": "Goal: €3,200 (~¥500,000)",
    ...
    "donate.item2.goal": "Goal: €2,500 (~¥400,000)",
    ...
    "footer.contactKh": "Cambodia office: Phnom Penh",
